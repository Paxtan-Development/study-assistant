 ...
 */
public class ProjectEditFragment extends Fragment implements FragmentOnBackPressed {
    ...
    public static ProjectEditFragment newInstance(String param1, String param2) {
